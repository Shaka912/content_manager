...
React.useEffect(() => {
    ...
    axios.get(`https://content-manager-iota.vercel.app/api/tags/create?userid=${id}`).then((res) => {
      console.log(res);
      settags1(res.data);
    }).catch((err) => {
      console.log(err);
    })
    axios.get(`https://content-manager-iota.vercel.app/api/subreddit/create?userid=${id}`).then((res) => {
      console.log(res);
