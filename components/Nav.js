...
import { logoutUser } from "../feautres/auth/authSlice";
    ...
    <>
      <aside className="p-4 pr-0 text-white">
        <Link className="flex gap-2 mb-4 mr-2" href={"/"}>
          ...
          <span className="md:text-xl font-bold">Content Manager</span>
        </Link>
        <div className="bg-white h-1 w-4/5 ml-4" />
        <nav className="flex flex-col gap-3 md:mt-10">
          ...
          <Link
            href={"/posts/create"}
            className={pathname.includes("/create") ? active : inactive}
          >
            <svg
              xmlns="http://www.w3.org/2000/svg"
              fill="none"
          ...
          <Link
            href={"/Addtags"}
            className={pathname.includes("/Addtags") ? active : inactive}
          >
            <svg
              xmlns="http://www.w3.org/2000/svg"
              fill="none"
